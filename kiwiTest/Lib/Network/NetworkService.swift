...
class NetworkService {
    ...
    func fetch<M: Decodable>(urlString: String, path: String, method: RequestMethod, params: JSON?, headers: HTTPHeaders?, completion: @escaping (Result<M, NetworkError>) -> ()) -> URLSessionDataTask? {
